...
#The following lines allows a node to move. If you commnet these lines the nodes willnot move.
for {set i 0} {$i < $val(nn)} {incr i} {
	$ns at [ expr 0.6+round(rand()) ] "$node_($i) setdest [ expr 10+round(rand()*480) ] [expr 10+round(rand()*380) ] [expr 60+round(rand()*30) ]"
}
