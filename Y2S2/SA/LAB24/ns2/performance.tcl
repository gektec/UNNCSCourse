...
# [scenario] It consists of 8 mobile nodes: 4 source nodes and 4 destination node. Each source is a CBR source over UDP.
# The size of a transmitted packet is 512 bytes. Transmission rate of a node is 600 Kbps.
...
for {set i 0} {$i < $val(nn) } {incr i} {
    $ns_ at 800.0 "$node_($i) reset";
}
 
# Exit Simulatoion at Time 80.01 sec
$ns_ at 800.01 "puts \"NS EXITING...\" ; $ns_ halt"
